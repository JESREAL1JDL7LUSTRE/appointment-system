...
## Summary
- 6134 nodes · 10026 edges · 529 communities (300 shown, 229 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 635 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5db5b075`
...
1. `service()` - 174 edges
2. `BaseBuilder` - 121 edges
3. `BaseConnection` - 70 edges
4. `BaseModel` - 69 edges
5. `Email` - 63 edges
6. `RouteCollection` - 58 edges
7. `HTTPException` - 45 edges
8. `Cookie` - 44 edges
9. `CodeIgniter` - 43 edges
10. `URI` - 43 edges
...
## Communities (529 total, 229 thin omitted)
...
Cohesion: 0.08
Nodes (4): AbstractValue, AbstractValue, AbstractValue, AbstractValue
...
Cohesion: 0.08
Nodes (10): BinaryPlugin, ColorPlugin, parseComplete(), PluginCompleteInterface, AbstractValue, AbstractValue, AbstractValue, AbstractValue (+2 more)
...
Cohesion: 0.12
Nodes (3): Image, BaseHandler, static

### Community 38 - "HTML Form Helpers"
Cohesion: 0.13
...
Cohesion: 0.10
Nodes (3): AbstractValue, AbstractValue, AbstractValue
...
### Community 85 - "Rich Data Renderer"
Cohesion: 0.24
Nodes (3): RichRenderer, AbstractValue, ContextInterface
...
Cohesion: 0.11
Nodes (7): BaseCast, ObjectCast, StringCast, DatetimeCast, FloatCast, IntegerCast, TimestampCast
...
Cohesion: 0.32
Nodes (3): MethodContext, InstanceValue, ReflectionMethod
